...
export const publishingProject: ProjectData[] = [
  {
    id: 1,
    ...
    description:
      "HTML, CSS, jQuery 기반으로 제작한 웹 퍼블리셔 이력용 반응형 포트폴리오로, 디자인·실무 퍼블리싱 작업물을 수록한 프로젝트입니다.",
  },
  {
    id: 2,
    title: "Becelo",
  ...
  },
  {
    ...
    description:
      "Flutter(Dart) 기반 앱 개발에 참여하며 화면 구성 및 코드 설명을 정리한 HTML/CSS 가이드 페이지를 제작하였습니다.",
  },
  {
    id: 4,
    title: "TravelyMap",
    ...
    description:
      "React 기반 웹앱 프로젝트에서 퍼블리셔로 참여하여, 퍼블리싱 코드를 직접 작성했습니다. 작성한 코드는 GitHub으로 관리하며, 이후 유지보수 작업을 맡아 진행했습니다.",
  },
  {
    id: 5,
    title: "HomtStudio",
  ...
  },
  {
    ...
    description:
      "HTML과 CSS를 사용해 웹앱의 기본 레이아웃을 퍼블리싱했고, 개발자와 협업을 위해 완성된 퍼블리싱 코드를 제공했습니다.",
  },
];
