...
export default function Features() {
  ...
  return (
    <section id="features">
      <div className="mb-10">
        <h2 className="text-2xl font-bold mb-2">주요 기능 상세 설명</h2>
        <p className="text-gray-400 font-light">
          담당 기능과 기여한 기능의 핵심 내용을 기술 스택과 함께 소개합니다.
        </p>
      </div>
      <section className="mb-8">
        <h3 className="flex items-center text-lg font-medium mb-3 ml-2 text-gray400">
          <div className="w-2 h-2 bg-gray400 mr-2" />
          공통 UI / 전역 컴포넌트
        </h3>
        <FeatureAccordion
          paramsId={paramsId}
