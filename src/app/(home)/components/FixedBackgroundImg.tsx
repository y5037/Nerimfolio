        ...
        {!loaded ? (
          ...
          <div
            className={clsx(
              ...
              "max-lg900:w-full",
              id === 1 &&
                "bg-albaform max-md:bg-[-90px] max-xs:bg-[-100px] bg-low-height-albaform",
              id === 2 &&
                "bg-pandamarket max-lg900:bg-[-40px] max-md:bg-[-90px] max-xs:bg-[-120px] bg-low-height-pandamarket",
